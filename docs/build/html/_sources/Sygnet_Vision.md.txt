...
Wygląda na to, że KWIE jest rozwiązaniem typu *permissioned system*, bo podmioty uczestniczące po obu stronach (czyli dawcy i biorcy informacji) muszą spełnić dość ostre kryteria opisane w ustawie. Powody wysokich wymagań dla dawców są dość jasne: trzeba mieć pewność, że dostarczana przez nich identyfikacja tożsamości jest wiarygodna. Wymogi po stronie biorców są równie wysokie, jednak ich zasadność jest dużo mniej oczywista:
